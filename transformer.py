...
class SelfAttention(nn.Module):
    def __init__(self, embed_size, heads):
        ...
        assert (self.head_dims*heads == embed_size), "Embed size needs to be divisible by heads"
    ...
    def forward(self, values, keys, query, mask):
        ...
        # queries shape : (N, query_len, heads, head_dims)
        # keys shape: (N, keys_len, head, heads_dims)
        ...
        # values shape: (N, values_len, heads, head_dims)
        # out shape: (N, query_len, heads, head_dims)
